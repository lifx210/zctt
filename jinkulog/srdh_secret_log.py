...
app_server_anme = '骚扰电话系统'
filename_sysname = '骚扰电话系统'
app_server_ip = 'IP'
...
if __name__ == '__main__':
    ...
    with open(mingan_dir + '10200'+'_SR_'+'mingan_'+creat_files_day+'_'+creat_files_hour+'.txt', 'a+') as f1, \
            open(jinku_dir + 'i_10200'+'_SR_'+'jinku_'+creat_files_day+'_'+creat_files_hour+'.txt', 'a+') as f2, \
            open(nomingan_dir + '10200'+'_SR_'+'nomingan_'+ creat_files_day+'_'+creat_files_hour+'.txt', 'a+') as f3:
        for x in logs.select():
            ...
            if description.find('SH') != -1:
                e_time = int(s_time) + int(round(float(temp_time.split(':')[1].split('s')[0])))
                mingan_touble = (username, username, '00', system_number, '0', app_server_ip, loginip,
                ...
                nomingan_touble = (username, username, '00', system_number, '0', app_server_ip,
